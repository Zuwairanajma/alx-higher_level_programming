...
This project taught me about the usage of object-relational mapping in database programming. I learned how to query, create, modify, and remove tables in MySQL using MySQLdb and SQLAlchemy.
